...
| [M3-05-loki-tool.md](M3-05-loki-tool.md) | Loki Tool | ai-agent-team | `done` |
| [M3-06-trace-tool.md](M3-06-trace-tool.md) | Trace Tool | ai-agent-team | `done` |
| [M3-07-git-context-tool.md](M3-07-git-context-tool.md) | Git Context Tool | ai-agent-team | `done` |
| [M3-08-incident-report-template.md](M3-08-incident-report-template.md) | Incident Report 模板 | docs-team | `done` |
| [M3-09-frontend-report.md](M3-09-frontend-report.md) | 前端展示 AI 分析结果 | frontend-team | `done` |
...
| [M3-15-knowledge-capture.md](M3-15-knowledge-capture.md) | 任务完成后知识沉淀 | ai-agent-team + docs-team | `done` |
| [M3-16-rag-evaluation.md](M3-16-rag-evaluation.md) | RAG Evaluation 与引用审计 | qa-team + ai-agent-team | `done` |
